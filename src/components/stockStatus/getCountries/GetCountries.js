...
class Dropdown extends React.Component {
    ...
    render() {
        if (this.props.error === false && this.props.countryArrayReceive ==false) {
            return <Form.Item style={{marginBottom:"0em"}} validateStatus={'none'} onClick={()=>{this.props.checkErrorForCountry()}}><Input className="filter-text" style={{ width:190 }} placeholder={this.props.placeholder}/></Form.Item>
         }
 
        else if (this.props.error === true && this.props.countryArrayReceive ==false) {
             return  <Form.Item help={"Please choose market"} style={{marginBottom:"0em"}} validateStatus="error"><Input className="filter-text" style={{ width:190 }} placeholder={this.props.placeholder}/></Form.Item> 
          }
