...
class GetSubCategory extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        if (this.props.error == false && this.props.subCategoryArrayReceive == false) {
            return <Form.Item style={{marginBottom:"0em"}} validateStatus={'none'} onClick={()=>{this.props.checkErrorForSubCategory()}}><Input className="filter-text" style={{ width:190 }} placeholder={this.props.placeholder}/></Form.Item>
         }
 
        else if (this.props.error == true && this.props.subCategoryArrayReceive == false) {
             return  <Form.Item help={"Please choose category"} style={{marginBottom:"0em"}} validateStatus="error"><Input className="filter-text" style={{ width:190 }} placeholder={this.props.placeholder}/></Form.Item> 
          }
